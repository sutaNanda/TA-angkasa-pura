...
<head>
    ...
    <title>New Account Credentials - Asset Monitoring System</title>
    <style>
        /* Base Reset */
        body {
                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            ...
                                            <p>An account has been successfully created for you in the <strong>Asset Monitoring System</strong>. You can now access the platform to view and manage your operational tasks.</p>
                                            ...
                                            <div class="signature">
                                                ...
                                                <br>
                                                <p>Best regards,</p>
                                                <p><strong>System Administration Team</strong><br>PT. Angkasa Pura Indonesia</p>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    ...
                                    <p>&copy; {{ date('Y') }} PT. Angkasa Pura - Asset Monitoring System. All rights reserved.</p>
                                </td>
                            </tr>
                        </table>
                    </div>
