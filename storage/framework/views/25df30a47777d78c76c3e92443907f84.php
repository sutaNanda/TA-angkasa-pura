...
<?php $__env->startSection('title', 'Setup Password Baru'); ?>
...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
    ...
    <div class="max-w-md w-full bg-white p-8 sm:p-10 rounded-3xl shadow-md border border-gray-100 relative z-10">
        ...
        <form class="mt-8 space-y-6" action="<?php echo e(route('password.update')); ?>" method="POST" x-data="{ showPass1: false, showPass2: false, password: '' }">
            <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input x-model="password" id="password" name="password" :type="showPass1 ? 'text' : 'password'" required 
                            class="block w-full pl-11 pr-12 py-3 border border-gray-300 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm transition-all shadow-sm <?php $__errorArgs = ['password'];
...
$message = $__bag->first($__errorArgs[0]); ?> 
                        <p class="text-rose-500 text-xs mt-1.5 font-medium flex items-center gap-1.5"><i class="fas fa-circle-exclamation"></i> <?php echo e($message); ?></p> 
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\tugas kuliah\TA\asset-monitoring\resources\views/auth/password_setup.blade.php ENDPATH**/ ?>