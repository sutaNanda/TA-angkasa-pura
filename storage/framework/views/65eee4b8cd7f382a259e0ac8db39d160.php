...
<?php $__env->startSection('title', 'Kategori Aset'); ?>
<?php $__env->startSection('page-title', 'Klasifikasi & Audit Aset'); ?>
                ...
                <?php if(isset($categories) && count($categories) > 0): ?>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="w-full flex items-center justify-between p-3 rounded-xl border border-transparent hover:border-gray-200 transition group category-item"
                                id="cat-item-<?php echo e($cat->id); ?>">
                            <button onclick="loadAssetsByCategory(<?php echo e($cat->id); ?>, '<?php echo e($cat->name); ?>', <?php echo e($cat->assets_count ?? 0); ?>, '<?php echo e($cat->description); ?>')"
                                ...
                                <div class="w-10 h-10 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center text-lg shadow-sm">
                                    <i class="<?php echo e($cat->icon ?? 'fa-solid fa-box'); ?>"></i>
                                </div>
                                <div class="flex-1">
                                    <h4 class="font-bold text-gray-800 text-sm"><?php echo e($cat->name); ?></h4>
                                    <p class="text-[10px] text-gray-500">Total: <?php echo e($cat->assets_count ?? 0); ?> Unit</p>
                                </div>
                            </button>
                            <?php if(!auth()->user()->isManajer()): ?>
                            <div class="flex gap-1 opacity-0 group-hover:opacity-100 transition">
                                <button onclick="openEditCategoryModal(<?php echo e($cat->id); ?>, '<?php echo e($cat->name); ?>', '<?php echo e($cat->description); ?>', '<?php echo e($cat->icon); ?>')" 
                                ...
                                <button onclick="deleteCategory(<?php echo e($cat->id); ?>, '<?php echo e($cat->name); ?>')" 
                    ...
                    <div class="bg-white px-6 py-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name"
                                ...
                                class="w-full rounded-lg text-sm focus:ring-blue-500 <?php echo e($errors->has('name') ? 'border-red-400 bg-red-50' : 'border-gray-300'); ?> border-2 border-gray-300 py-2 pl-2"
                                required placeholder="Kategori">
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-1">Deskripsi</label>
                            <textarea name="description" rows="2" class="w-full border-gray-300 rounded-lg text-sm focus:ring-blue-500 py-2 pl-2 border-2 border-gray-300" placeholder="Deskripsi"><?php echo e(old('description')); ?></textarea>
                        </div>
                        <div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\tugas kuliah\TA\asset-monitoring\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>