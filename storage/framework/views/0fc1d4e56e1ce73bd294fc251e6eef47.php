<header class="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-40">
    <div class="h-16 flex items-center justify-between px-6">
        <h2 class="text-xl font-semibold text-gray-800 truncate">
            <?php echo $__env->yieldContent('page-title', 'Halaman Admin'); ?>
        </h2>

        <div class="flex items-center gap-4 shrink-0">
            
            <span class="text-sm text-gray-700">Hello, <strong class="font-bold text-gray-900"><?php echo e(Auth::user()->name ?? 'Admin'); ?></strong></span>
            ...
            <button type="button" onclick="openAdminProfileModal()" class="relative w-9 h-9 rounded-full bg-blue-100 flex items-center justify-center border-2 border-transparent hover:border-blue-400 focus:outline-none transition group overflow-hidden shadow-sm">
                <?php if(Auth::user()->avatar): ?>
                    <img src="<?php echo e(asset('storage/' . Auth::user()->avatar)); ?>" class="w-full h-full object-cover" alt="Profile">
                <?php else: ?>
                ...
                <div class="bg-white px-6 py-5">
                    ...
                    <div class="flex flex-col items-center mb-6">
                        <div class="relative w-24 h-24 rounded-full border border-gray-200 bg-gray-50 shadow-sm overflow-hidden mb-2 group cursor-pointer" onclick="document.getElementById('adminAvatarInput').click()">
                            <img id="adminProfilePreview" src="<?php echo e(Auth::user()->avatar ? asset('storage/' . Auth::user()->avatar) : 'https://via.placeholder.com/150?text=No+Photo'); ?>" class="w-full h-full object-cover">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="name" value="<?php echo e(old('name', Auth::user()->name)); ?>" class="pl-10 w-full border border-gray-300 rounded-lg text-sm px-3 py-2.5 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none transition shadow-sm" required placeholder="Masukkan nama Anda">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" value="<?php echo e(old('email', Auth::user()->email)); ?>" class="pl-10 w-full border border-gray-300 rounded-lg text-sm px-3 py-2.5 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none transition shadow-sm" required placeholder="email@contoh.com">
                            </div>
                        </div>
...
<?php /**PATH C:\Users\User\Documents\tugas kuliah\TA\asset-monitoring\resources\views/components/admin-header.blade.php ENDPATH**/ ?>