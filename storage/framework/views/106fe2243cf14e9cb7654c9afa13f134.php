...
<?php $__env->startSection('title', 'Aturan Preventive Maintenance'); ?>
<?php $__env->startSection('page-title', 'Rencana Maintenance'); ?>
...
<div class="container-fluid px-4 py-6 max-w-7xl mx-auto w-full overflow-hidden">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        ...
        <div class="flex flex-wrap items-center gap-3 w-full sm:w-auto">
            ...
            <a href="<?php echo e(route('admin.plans.create')); ?>" class="w-full sm:w-auto inline-flex justify-center items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-lg text-sm font-medium transition shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1">
        ...
        <div class="bg-white p-5 rounded-xl shadow-sm border border-green-100 hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-700 mt-1"><?php echo e($stats['active']); ?></p>
                </div>
        ...
        <div class="bg-white p-5 rounded-xl shadow-sm border border-blue-100 hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-blue-700 mt-1"><?php echo e($stats['daily']); ?></p>
                </div>
        ...
        <div class="bg-white p-5 rounded-xl shadow-sm border border-purple-100 hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-purple-700 mt-1"><?php echo e($stats['weekly']); ?></p>
                </div>
        ...
        <div class="bg-white p-5 rounded-xl shadow-sm border border-orange-100 hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-orange-700 mt-1"><?php echo e($stats['monthly']); ?></p>
                </div>
        ...
        <div class="bg-white p-5 rounded-xl shadow-sm border border-red-100 hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-red-700 mt-1"><?php echo e($stats['yearly']); ?></p>
                </div>
            ...
            <table class="w-full min-w-[1000px] divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50/50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-500">
                                <?php echo e(($plans->currentPage() - 1) * $plans->perPage() + $loop->iteration); ?>
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex flex-wrap gap-1 mt-1.5">
                                            <?php $__currentLoopData = $plan->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td class="px-6 py-4">
                                <ul class="space-y-1">
                                    <?php $__currentLoopData = $plan->templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                ?>
                                <span class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium ring-1 ring-inset <?php echo e($badgeColors[$plan->frequency] ?? 'bg-gray-50 text-gray-600 ring-gray-500/10'); ?>">
                                    <?php echo e(strtoupper($plan->frequency)); ?>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-col gap-1 min-w-[120px]">
                                    <?php if($plan->shift): ?>
                                        <div>
                                            <span class="<?php echo e($plan->shift->badge_class); ?> inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-medium border whitespace-nowrap">
                                                <i class="<?php echo e($plan->shift->icon_class); ?>"></i> <?php echo e($plan->shift->name); ?>
                                    ...
                                    <div class="text-sm text-gray-600 mt-1 flex flex-col gap-0.5">
                                        <span class="line-clamp-2" title="<?php echo e($plan->schedule_description); ?>">
                                            <?php echo e($plan->schedule_description); ?>

                                        </span>
                                        <?php if($plan->start_time): ?>
                                            <span class="text-[11px] font-bold text-blue-600 flex items-center gap-1"><i class="fa-regular fa-clock"></i> Jam <?php echo e(\Carbon\Carbon::parse($plan->start_time)->format('H:i')); ?></span>
                                        <?php else: ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gray-50 border border-gray-200">
                                    <span class="text-sm font-semibold text-gray-700"><?php echo e($plan->affected_assets_count); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <?php if(!auth()->user()->isManajer()): ?>
                                    <button onclick="toggleActive(<?php echo e($plan->id); ?>, <?php echo e($plan->is_active ? 'true' : 'false'); ?>)" 
                                        class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1 <?php echo e($plan->is_active ? 'bg-green-100 text-green-700 hover:bg-green-200 focus:ring-green-500' : 'bg-gray-100 text-gray-600 hover:bg-gray-200 focus:ring-gray-500'); ?>">
                                        <span class="w-1.5 h-1.5 rounded-full mr-1.5 <?php echo e($plan->is_active ? 'bg-green-500' : 'bg-gray-400'); ?>"></span>
                                        <?php echo e($plan->is_active ? 'Aktif' : 'Nonaktif'); ?>

                                    </button>
                                <?php else: ?>
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium <?php echo e($plan->is_active ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600'); ?>">
                                        <span class="w-1.5 h-1.5 rounded-full mr-1.5 <?php echo e($plan->is_active ? 'bg-green-500' : 'bg-gray-400'); ?>"></span>
                                        <?php echo e($plan->is_active ? 'Aktif' : 'Nonaktif'); ?>
                            ...
                            <td class="px-6 py-4 pr-8 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center gap-3">
                                    ...
                                    <button onclick="deletePlan(<?php echo e($plan->id); ?>)" 
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="<?php echo e(!auth()->user()->isManajer() ? '8' : '7'); ?>" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <?php if(!auth()->user()->isManajer()): ?>
                                        <a href="<?php echo e(route('admin.plans.create')); ?>" class="text-blue-600 hover:text-blue-700 font-medium text-sm mt-2 hover:underline">
                                            + Tambah aturan baru
                                        </a>
                                    <?php endif; ?>
                                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\tugas kuliah\TA\asset-monitoring\resources\views/admin/plans/index.blade.php ENDPATH**/ ?>