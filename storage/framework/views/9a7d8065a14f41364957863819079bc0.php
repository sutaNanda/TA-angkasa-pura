<?php if(auth()->guard()->check()): ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const sessionLifetime = <?php echo e(config('session.lifetime')); ?> * 60 * 1000;
            ...
            function extendSession() {
                fetch("<?php echo e(route('session.keep-alive')); ?>", {
                    method: "POST",
                    headers: {
...
<?php endif; ?>
<?php /**PATH C:\Users\User\Documents\tugas kuliah\TA\asset-monitoring\resources\views/components/session-warning.blade.php ENDPATH**/ ?>