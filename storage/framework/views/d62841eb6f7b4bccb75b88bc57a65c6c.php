...
<?php $__env->startSection('title', 'Tambah Rencana Perawatan'); ?>
...
<div class="container-fluid px-4 py-6 max-w-7xl mx-auto" x-data="maintenancePlanForm()">
    ...
    <form action="<?php echo e(route('admin.plans.store')); ?>" method="POST" id="createPlanForm">
        <?php echo csrf_field(); ?>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-8">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name')); ?>" required placeholder="Contoh: Pengecekan Rutin Ruang PIONA" class="w-full rounded-xl border border-gray-300 px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm outline-none">
                    ...
                    <div class="p-6 space-y-8">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                <label class="cursor-pointer group">
                                    ...
                                    <div class="p-4 py-2 rounded-xl border-2 transition-all duration-200 text-center bg-white border-gray-200 hover:bg-gray-50 hover:border-gray-300 peer-checked:border-<?php echo e($freq['color']); ?>-500 peer-checked:bg-<?php echo e($freq['color']); ?>-50/40 peer-checked:ring-1 peer-checked:ring-<?php echo e($freq['color']); ?>-500">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="start_date" value="<?php echo e(old('start_date', date('Y-m-d'))); ?>" required class="w-full sm:w-1/2 rounded-xl border border-gray-300 bg-gray-50/50 px-4 py-3 text-sm focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 transition-all outline-none cursor-pointer text-gray-700">
                            ...
                            <div class="pt-6 border-t border-gray-100">
                                <?php echo $__env->make('admin.plans.partials.group_repeater', ['plan' => null], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 space-y-6 lg:sticky lg:top-8">
                    ...
                    <div>
                        <div class="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-200 shadow-sm hover:border-blue-300 transition-colors cursor-pointer" @click="$refs.statusToggle.click()">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer pointer-events-none">
                                <input type="checkbox" x-ref="statusToggle" name="is_active" value="1" <?php echo e(old('is_active', true) ? 'checked' : ''); ?> class="sr-only peer">
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="5" class="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm outline-none resize-none" placeholder="Tulis instruksi khusus atau catatan untuk teknisi di sini..."><?php echo e(old('notes')); ?></textarea>
                    </div>
...
<script>
    ...
    function maintenancePlanForm() {
        return {
            targetType: '<?php echo e(old('target_type', 'asset')); ?>',
            frequency: '<?php echo e(old('frequency', 'daily')); ?>',
            configs: <?php echo json_encode(array_values(old('configs', [['category_id' => '', 'template_id' => '']]))); ?>,
            assets: [],
            selectedAssets: <?php echo json_encode(old('asset_ids', [])); ?>,
            locations: <?php echo json_encode($locations); ?>,
            selectedLocations: <?php echo json_encode(old('location_ids', [])); ?>,
            searchQueryAsset: '',
            searchQueryLocation: '',
            isLoading: false,
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\tugas kuliah\TA\asset-monitoring\resources\views/admin/plans/create.blade.php ENDPATH**/ ?>